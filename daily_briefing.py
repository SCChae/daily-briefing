...
{{
  ...
  "schedule": "일정 요약 (00:00은 종일 일정으로 언급, 2-3문장 이내)",
  "special_day": "특일 정보가 있으면 간단히 언급, 없으면 null",
  "fact": "잡학사실 한국어 번역과 재미있는 코멘트 (2-3문장), 잡학사실 내용이 성적인 내용을 포함하거나 불쾌감을 유발하는 내용이면 null",
